...
#pragma warning restore IDE1006 // Naming Styles
        ...
        public struct ConnectionAddressData
        {
            ...
            private static NetworkEndpoint ParseNetworkEndpoint(string ip, ushort port, bool silent = false)
            {
                ...
                //#if UNITY_WEBGL
                //                FixedString512Bytes addr = new($"{ip}:{port}");
                //                endpoint = new NetworkEndpoint(addr);
                //#endif
                return endpoint;
            }
...
#else
            FixedString512Bytes address = "devworldofmine.online";
            ushort port = 443;
            var addressStr = new FixedString512Bytes();
            addressStr.Append(address);
            addressStr.Append(":");
            addressStr.Append(port);
            serverEndpoint = new NetworkEndpoint(addressStr);
#endif
